  ...
  return (
    <>
      <header className="flex items-center gap-3 px-4 py-2 bg-slate-900 border-b border-slate-700 flex-shrink-0 z-30">
        ...
        {/* XP Level */}
        <div className="flex items-center gap-2 bg-slate-800 border border-slate-700 rounded-xl px-3 py-1.5 flex-shrink-0">
          <div
        ...
        {user ? (
          <div className="flex items-center gap-2 flex-shrink-0">
            {/* Avatar + name → opens ProfileModal */}
            <button
              onClick={() => setShowProfile(true)}
              className="flex items-center gap-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-xl px-2.5 py-1.5 transition-colors"
            >
              <div
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-blue-600 hover:bg-blue-500 text-white rounded-xl px-3 py-1.5 text-xs font-black transition-colors shadow-lg shadow-blue-500/20 flex-shrink-0"
          >
            🔑 Entrar
          </button>
        )}
